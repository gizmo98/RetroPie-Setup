...
function depends_sdl() {
    rps_checkNeededPackages libudev-dev libaudio-dev libasound2-dev libdbus-1-dev libx11-dev libxrandr-dev libxcursor-dev libxi-dev libxxf86vm-dev libesd0-dev libegl1-mesa-dev unzip 
}
...
function sources_sdl() {
    ...
    # -C "$rootdir/supplementary/"
    rm SDL2-2.0.1.tar.gz || return 1
    unzip \*.zip
    rm SDL2_ttf-2.0.12.zip
